...
const AIChatbot = () => {
  ...
  if (!isOpen) {
    return (
      <button
        ...
        className="fixed bottom-6 right-32 z-50 bg-gradient-to-r from-purple-500 to-pink-500 text-white rounded-full p-5 shadow-2xl hover:scale-110 transition-all duration-300 group opacity-70 hover:opacity-100"
  ...
  return (
    <Card className="fixed bottom-6 right-32 z-50 w-[400px] h-[600px] shadow-2xl flex flex-col animate-fade-in border-2 border-purple-200">
