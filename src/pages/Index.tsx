  ...
  return (
    <div className="min-h-screen relative">
      ...
      <section id="cases" className="py-20 px-6 relative overflow-hidden bg-gradient-to-br from-slate-50 via-blue-50/30 to-slate-100">
        ...
        <div className="absolute top-20 right-10 w-[400px] h-[400px] bg-blue-200/20 rounded-full blur-3xl"></div>
        <div className="absolute bottom-20 left-10 w-[500px] h-[500px] bg-slate-300/20 rounded-full blur-3xl"></div>
        <div className="container mx-auto max-w-7xl relative z-10">
          <div className="text-center mb-16">
          ...
          <div className="grid md:grid-cols-2 gap-8">
            <Card className="group hover:shadow-2xl transition-all duration-300 hover:-translate-y-2 bg-white backdrop-blur-sm shadow-lg border border-slate-200/60 hover:border-primary hover:shadow-primary/20 reveal-text stagger-1">
              <CardHeader>
            ...
            <Card className="group hover:shadow-2xl transition-all duration-300 hover:-translate-y-2 bg-white backdrop-blur-sm shadow-lg border border-slate-200/60 hover:border-primary hover:shadow-primary/20 reveal-text stagger-2">
              <CardHeader>
                <div className="flex items-start justify-between mb-3">
            ...
            <Card className="group hover:shadow-2xl transition-all duration-300 hover:-translate-y-2 bg-white backdrop-blur-sm shadow-lg border border-slate-200/60 hover:border-primary hover:shadow-primary/20 reveal-text stagger-3">
              <CardHeader>
                <div className="flex items-start justify-between mb-3">
            ...
            <Card className="group hover:shadow-2xl transition-all duration-300 hover:-translate-y-2 bg-white backdrop-blur-sm shadow-lg border border-slate-200/60 hover:border-primary hover:shadow-primary/20 reveal-text stagger-4">
              <CardHeader>
                <div className="flex items-start justify-between mb-3">
      ...
      <section id="reviews" className="py-20 px-6 relative overflow-hidden bg-gradient-to-br from-blue-50/40 via-white to-indigo-50/30">
        ...
        <div className="absolute top-20 left-10 w-[600px] h-[600px] bg-blue-200/10 rounded-full blur-3xl"></div>
        <div className="absolute bottom-20 right-10 w-[500px] h-[500px] bg-indigo-200/10 rounded-full blur-3xl"></div>
        <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-[700px] h-[700px] bg-gradient-to-br from-blue-100/5 to-purple-100/5 rounded-full blur-3xl"></div>
        
        <div className="absolute inset-0 opacity-[0.02]">
          <svg className="w-full h-full" xmlns="http://www.w3.org/2000/svg">
            <defs>
              <pattern id="hearts" x="0" y="0" width="100" height="100" patternUnits="userSpaceOnUse">
                <path d="M50 70 L35 55 Q25 45 25 35 Q25 20 35 20 Q45 20 50 30 Q55 20 65 20 Q75 20 75 35 Q75 45 65 55 Z" fill="#3b82f6" opacity="0.5"/>
              </pattern>
            </defs>
